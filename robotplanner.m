function[action] = robotplanner(envmap, robotpos, targetpos, payloadpos, fuelpos, C, D, P, F, Fcur, Fmax)
...
if (MEX == 1)
	...
	action = planner(envmap, robotpos, targetpos, payloadpos, fuelpos, C, D, P, F, Fcur, Fmax);
